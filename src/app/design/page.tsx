...
export default function DesignPage() {
  const sections = [
    { title: 'Kitchen', subtitle: '500+ Yogita Interior Designs', image: '/design/kitchendesign.png' },
    { title: 'Living Room', subtitle: '500+ Yogita Interior Designs', image: '/design/livingroom.png' },
    { title: 'Master Bedroom', subtitle: '500+ Yogita Interior Designs', image: '/design/bedroom.png' },
    { title: 'Wardrobe', subtitle: '500+ Yogita Interior Designs', image: '/design/wardrore.png' },
    { title: 'Dining Room', subtitle: '500+ Yogita Interior Designs', image: '/design/dining.png' },
    { title: "Kid's Bedroom", subtitle: '500+ Yogita Interior Designs', image: '/design/kid room.png' },
    { title: 'Bathroom', subtitle: '500+ Yogita Interior Designs', image: '/design/bathroom.png' },
    { title: 'Balcony', subtitle: '500+ Yogita Interior Designs', image: '/design/balcony.png' },
    { title: 'Pooja Room', subtitle: '500+ Yogita Interior Designs', image: '/design/poojaroom.png' },
  ];
    ...
    <main className="bg-black w-full px-4 md:px-12 py-12 pt-14">
      ...
      <div className="mb-12 text-left">
        <h2 className="text-3xl md:text-5xl font-bold text-transparent bg-gradient-to-r from-[#FFD700] to-white bg-clip-text border-l-4 border-[#FFD700] pl-4 inline-block">
          Yogita Interior – Home Design Gallery
        </h2>
        <p className="mt-4 text-gray-300 max-w-3xl text-base md:text-lg text-left">
          Explore a curated collection of home interior designs by Yogita Interior. From kitchens and
      ...
      <section className="mt-24 bg-[#111] rounded-xl p-8 border border-[#333]">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#FFD700] to-white bg-clip-text text-transparent">
            Yogita Interior Turnkey Solutions
          </h2>
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
            With Yogita Interior, you get complete end-to-end interior solutions — from layout
          ...
          {['/design/turnkey1.png', '/design/turnkey2.png', '/design/turnkey3.png'].map((img, i) => (
            <Link href="/contactus" key={i}>
              <div className="relative h-64 rounded-xl overflow-hidden cursor-pointer">
                <Image src={img} alt={`Yogita Interior Turnkey Design ${i + 1}`} fill className="object-cover" />
              </div>
            </Link>
          ))}
        </div>
      ...
      <section className="mt-24 bg-[#111] rounded-xl p-8 border border-[#333]">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#FFD700] to-white bg-clip-text text-transparent">
            Style Inspiration by Yogita Interior
          </h2>
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
            Discover signature styles curated by Yogita Interior — from Scandinavian minimalism and
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {['/design/style1.png', '/design/style2.png', '/design/style3.png', '/design/style4.png'].map(
            (img, i) => (
              <Link href="/contactus" key={i}>
                <div className="relative h-64 rounded-xl overflow-hidden cursor-pointer">
                  <Image src={img} alt={`Yogita Interior Style Inspiration ${i + 1}`} fill className="object-cover" />
                </div>
              </Link>
            )
          )}
