    ...
    <section className="bg-black py-16 px-6">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-4xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-[#FFD700] to-white text-transparent bg-clip-text animate-pulse">
          How Laxmi Interior Works
        </h2>
        <p className="text-gray-300 max-w-2xl mx-auto mb-12">
          At Laxmi Interior, we make interior design simple and stress-free with a clear process, expert guidance, and end-to-end execution tailored to your home and lifestyle.
        </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2 relative h-64 rounded-lg overflow-hidden shadow-lg hover:shadow-[0_0_25px_#FFD70099] transition">
              <Image
                ...
                alt="Laxmi Interior full home design"
                fill
            ...
            <div className="relative h-40 rounded-lg overflow-hidden shadow hover:shadow-[0_0_15px_#FFD70055] transition">
              <Image
                src="/home/luxury.png"
                alt="Laxmi Interior luxury interior concept"
                fill
                className="object-cover"
              />
            </div>
            <div className="relative h-40 rounded-lg overflow-hidden shadow hover:shadow-[0_0_15px_#FFD70055] transition">
              <Image
                ...
                alt="Laxmi Interior modern living space"
                fill
                className="object-cover"
              />
            </div>
