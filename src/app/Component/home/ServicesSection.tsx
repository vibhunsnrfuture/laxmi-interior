...
const services = [
  {
    ...
    description: 'Premium modular kitchens, wardrobes, and smart storage by Yogita Interior.',
    ...
    <section className="bg-black py-16 px-6">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-[#FFD700] to-white text-transparent bg-clip-text animate-pulse">
          Yogita Interior – Your Complete Interior Solutions Partner
        </h2>

        <p className="text-gray-400 max-w-2xl mx-auto mb-12">
          From modular kitchens to full home interiors, luxury designs, and professional renovations —
          Yogita Interior delivers end-to-end solutions with exceptional craftsmanship and timeless style.
        </p>
