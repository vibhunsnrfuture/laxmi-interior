...
const reasons = [
  { icon: '/icons/image copy 3.png', title: 'Easy EMIs' },
  { icon: '/icons/image copy 4.png', title: '60+ In-House Designers' },
  { icon: '/icons/image.png', title: '450+ Homes Delivered' },
  { icon: '/icons/image copy 5.png', title: '10 Studios' },
  { icon: '/icons/image copy 6.png', title: '40 Cities' },
  { icon: '/icons/image copy 7.png', title: 'Delivery in 45 days*' },
  { icon: '/icons/image copy 8.png', title: 'No Hidden Costs' },
